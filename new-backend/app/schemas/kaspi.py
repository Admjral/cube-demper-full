...
# Available cities for Kaspi (city IDs from MC GraphQL `cities` query)
# NOTE: These IDs match both MC GraphQL and public offers API
KASPI_CITIES = {
    "750000000": "Алматы",
    "710000000": "Астана",
    "511010000": "Шымкент",
...
class ProductCityPricesRequest(BaseModel):
    ...
    run_demping: bool = False  # Run demping after saving settings
