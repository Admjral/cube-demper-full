...
export const FEATURE_UPGRADE_INFO: Record<string, {
  ...
  niche_search: {
    plans: ['Стандарт', 'Премиум'],
    addons: [],
    message: 'Доступно на тарифе Стандарт или Премиум'
  },
  city_demping: {
    plans: ['Стандарт', 'Премиум'],
    addons: ['Демпер по городам'],
    message: 'Доступно на тарифе Стандарт или Премиум, либо приобретите доп. услугу «Демпер по городам»'
  },
  ai_lawyer: {
    plans: ['Базовый', 'Стандарт', 'Премиум'],
    addons: [],
    message: 'Доступно на тарифе Базовый, Стандарт или Премиум'
  },
  unit_economics: {
    plans: ['Базовый', 'Стандарт', 'Премиум'],
    addons: [],
  ...
  analytics: {
    plans: ['Базовый', 'Стандарт', 'Премиум'],
    addons: ['Аналитика безлимит'],
    message: 'Доступно на тарифе Базовый, Стандарт или Премиум, либо приобретите доп. услугу «Аналитика безлимит»'
  },
  demping: {
    plans: ['Базовый', 'Стандарт', 'Премиум'],
    addons: ['Демпинг +100'],
    message: 'Доступно на тарифе Базовый, Стандарт или Премиум, либо приобретите доп. услугу «Демпинг +100»'
  },
  orders_view: {
    plans: ['Базовый', 'Стандарт', 'Премиум'],
    addons: [],
  ...
  delivery_demping: {
    plans: ['Премиум'],
    addons: ['Демпер по доставке'],
    message: 'Доступно на тарифе Премиум, либо приобретите доп. услугу «Демпер по доставке»'
  },
  priority_products: {
    plans: ['Премиум'],
    addons: [],
    message: 'Доступно на тарифе Премиум'
  },
}
