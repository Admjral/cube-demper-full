...
const faqs = [
  ...
  },
  {
    ...
    answer: 'ИИ-ассистенты (Юрист, Продажник) используют современные языковые модели, обученные на казахстанском законодательстве и бизнес-практиках. Они помогают с консультациями и автоматизацией.',
  },
]
